...
class Strategy_Knight_Rush_Dummy(Strategy):
    ...
    def move_action_decision(self, game_state: GameState, my_player_index: int) -> Position:
        ...
        if (current_position.x, current_position.y) == self.start_positions[my_player_index] and my_player.gold >= Item.RALLY_BANNER.value.cost and my_player.item == Item.NONE:
    ...
    def buy_action_decision(self, game_state: GameState, my_player_index: int) -> Item:
        ...
        if (my_position.x, my_position.y) == self.start_positions[my_player_index] and my_player.gold >= Item.RALLY_BANNER.value.cost:
